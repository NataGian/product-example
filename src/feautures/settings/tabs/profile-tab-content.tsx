                ...
                <CardContent className="space-y-6">
                    ...
                    <div className="grid gap-4 md:grid-cols-2">
                        ...
                        <div className="space-y-2">
                            ...
                            <Input id="lastName" placeholder="Παπαδόπουλος"
                                   defaultValue="Παπαδόπουλος"/>
                        </div>
                    </div>
                    <div className="space-y-2">
                        <Label htmlFor="email">Email</Label>
                        <Input id="email" type="email" placeholder="giannis.papadopoulos@example.com"
                               defaultValue="giannis.papadopoulos@example.com"/>
                    </div>
                    <div className="space-y-2">
                        <Label htmlFor="bio">Βιογραφικό</Label>
                        <Textarea id="bio" placeholder="Πείτε μας για τον εαυτό σας"
                                  className="min-h-32"/>
                    </div>
                </CardContent>
