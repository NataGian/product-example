...
function TooltipProvider(_a) {
    var { delayDuration = 0 } = _a, props = tslib_es6.__rest(_a, ["delayDuration"]);
...
function TooltipContent(_a) {
    var { className, sideOffset = 0, children } = _a, props = tslib_es6.__rest(_a, ["className", "sideOffset", "children"]);
