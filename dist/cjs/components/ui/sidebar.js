...
function SidebarProvider(_a) {
    var { defaultOpen = true, open: openProp, onOpenChange: setOpenProp, className, style, children } = _a, props = tslib_es6_js.__rest(_a, ["defaultOpen", "open", "onOpenChange", "className", "style", "children"]);
...
function Sidebar(_a) {
    var { side = "left", variant = "sidebar", collapsible = "offcanvas", className, children } = _a, props = tslib_es6_js.__rest(_a, ["side", "variant", "collapsible", "className", "children"]);
...
function SidebarTrigger(_a) {
    var { className, onClick } = _a, props = tslib_es6_js.__rest(_a, ["className", "onClick"]);
...
function SidebarGroupLabel(_a) {
    var { className, asChild = false } = _a, props = tslib_es6_js.__rest(_a, ["className", "asChild"]);
...
function SidebarMenuButton(_a) {
    var { asChild = false, isActive = false, variant = "default", size = "default", tooltip: tooltip$1, className } = _a, props = tslib_es6_js.__rest(_a, ["asChild", "isActive", "variant", "size", "tooltip", "className"]);
    const Comp = asChild ? reactSlot.Slot : "button";
...
function SidebarMenuAction(_a) {
    var { className, asChild = false, showOnHover = false } = _a, props = tslib_es6_js.__rest(_a, ["className", "asChild", "showOnHover"]);
    const Comp = asChild ? reactSlot.Slot : "button";
...
function SidebarMenuSkeleton(_a) {
    var { className, showIcon = false } = _a, props = tslib_es6_js.__rest(_a, ["className", "showIcon"]);
...
function SidebarMenuSubButton(_a) {
    var { asChild = false, size = "md", isActive = false, className } = _a, props = tslib_es6_js.__rest(_a, ["asChild", "size", "isActive", "className"]);
